    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="usuario-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="<?=getUrl('Usuarios','Usuarios','consult')?>" class="link-dark rounded">Consultar</a></li>
          </ul>
        </div>
      </li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="estrato-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="<?=getUrl('Estratos','Estratos','getInsert')?>" class="link-dark rounded">Registrar</a></li>
            <li><a href="<?=getUrl('Estratos','Estratos','consult')?>" class="link-dark rounded">Consultar</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse" id="genero-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="<?=getUrl('Generos','Generos','getInsert')?>" class="link-dark rounded">Registrar</a></li>
            <li><a href="<?=getUrl('Generos','Generos','consult')?>" class="link-dark rounded">Consultar</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse" id="hobbies-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="<?=getUrl('Hobbies','Hobbies','getInsert')?>" class="link-dark rounded">Registrar</a></li>
            <li><a href="<?=getUrl('Hobbies','Hobbies','consult')?>" class="link-dark rounded">Consultar</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
        ...
        <div class="collapse" id="rol-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="<?=getUrl('Rol','Rol','getInsert')?>" class="link-dark rounded">Registrar</a></li>
            <li><a href="<?=getUrl('Rol','Rol','consult')?>" class="link-dark rounded">Consultar</a></li>
          </ul>
        </div>
      </li>
      <li class="border-top my-3"></li>
